...
export default function AdminPelangganPage() {
  ...
  const getWhatsAppChatUrl = (customer: CustomerItem) => {
    ...
    const greeting = customer.company
      ? `Halo Bapak/Ibu ${customer.name} (${customer.company}), salam hangat dari tim kami.`
      : `Halo Bapak/Ibu ${customer.name}, salam hangat dari tim kami.`;
  ...
  return (
    <div className="min-h-screen bg-slate-50/60 pb-16">
      {/* Header Bar */}
      <div className="border-b border-slate-200 bg-white relative z-10 md:sticky md:top-0 md:z-20">
