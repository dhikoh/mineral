...
export const DEFAULT_CONTENT_BLOCKS: ContentBlockItem[] = [
  ...
  {
    id: 'block-supplier-cta',
    key: 'supplier_cta',
    title: 'Punya Stok Komoditas? Jual Melalui Platform Kami',
    content: 'Zeolite, Bentonite, Kaolin, Pasir Silika, dan mineral lainnya — isi form penawaran singkat dan tim kami akan menghubungi Anda dalam 1×24 jam.',
    updatedAt: new Date().toISOString(),
  },
  {
    id: 'block-about',
