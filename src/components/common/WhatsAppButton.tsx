...
export function WhatsAppButton({
  ...
  defaultMessage = 'Halo Tim MineralHub, saya tertarik berkonsultasi mengenai pemesanan komoditas mineral...',
}: WhatsAppButtonProps) {
      ...
      {showTooltip && (
        <div className="mb-2.5 max-w-[220px] rounded-2xl border border-emerald-100 bg-white p-3 shadow-soft-lg animate-in fade-in zoom-in-95 duration-200">
          ...
          <p className="mt-1 text-[11px] text-slate-500 leading-relaxed">
            Chat langsung dengan tim teknis & logistik MineralHub via WhatsApp.
          </p>
        </div>
      )}
